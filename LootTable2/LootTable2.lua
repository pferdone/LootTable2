...
function LootTable2:OnUpdateVitals()
	tVitals = Unit.GetVitalTable()
end
...
function LootTable2:HelperCalculateConValue(unitTarget)
...
function LootTable2:CreateCallNames()
...
function LootTable2:OnGenerateWorldObjectTooltip( wndHandler, wndControl, eToolTipType, unit, strPropName )
...
function LootTable2:OnMouseOverUnitChanged(unit)
